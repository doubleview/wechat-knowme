 ...
 * 机器人聊天服务
 */
public class RobotService implements WxMpMessageHandler{
    ...
    //配置您申请的KEY
    public static final String APPKEY ="29bbc050c02b335843e50fcbbc220def";

    //1.问答
    public static String getRequest(String word , String userId){
        String result =null;
        String url ="http://op.juhe.cn/robot/index";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("key",APPKEY);//您申请到的本接口专用的APPKEY
        params.put("info",word);//要发送给机器人的内容，不要超过30个字符
        params.put("dtype","json");//返回的数据的格式，json或xml，默认为json
        //params.put("loc","杭州西湖");//地点，如北京中关村
    ...
    public static void main(String[] args) {
        ...
        String data = robotService.getRequest("你好" , "1");
    ...
    public WxMpXmlOutMessage handle(WxMpXmlMessage wxMpXmlMessage, Map<String, Object> map, WxMpService wxMpService, WxSessionManager wxSessionManager) throws WxErrorException {
        ...
        String userid = wxMpXmlMessage.getFromUserName();
        String result  = getRequest(content , userid);
